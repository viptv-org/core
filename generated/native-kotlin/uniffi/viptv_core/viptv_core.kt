   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.INSTANCE.ffi_viptv_core_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_viptv_core_rustbuffer_free(buf, status)
        }
    }
...
fun uniffi_viptv_core_checksum_method_corebridge_update(
): Short
...
fun ffi_viptv_core_rust_future_cancel_u8(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_i8(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_u16(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_i16(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_u32(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_i32(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_u64(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_i64(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_f32(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_f64(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_pointer(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_rust_buffer(`handle`: Long,
): Unit
...
fun ffi_viptv_core_rust_future_cancel_void(`handle`: Long,
): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_viptv_core_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_viptv_core_checksum_method_corebridge_update() != 44813.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class CoreBridge: Disposable, AutoCloseable, CoreBridgeInterface
{
    ...
    UniffiLib.INSTANCE.uniffi_viptv_core_fn_constructor_corebridge_new(
        _status)
}
    )
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_viptv_core_fn_free_corebridge(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_viptv_core_fn_clone_corebridge(pointer!!, status)
        }
    }
    ...
    UniffiLib.INSTANCE.uniffi_viptv_core_fn_method_corebridge_resolve(
        it, FfiConverterUInt.lower(`id`),FfiConverterString.lower(`result`),_status)
}
    }
    )
    }
    ...
    callWithPointer {
    uniffiRustCallWithError(CoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_viptv_core_fn_method_corebridge_update(
    ...
    callWithPointer {
    uniffiRustCallWithError(CoreException) { _status ->
    UniffiLib.INSTANCE.uniffi_viptv_core_fn_method_corebridge_view(
        it, _status)
}
    }
    )
 ...
 * @suppress
 */
public object FfiConverterTypeCoreBridge: FfiConverter<CoreBridge, Pointer> {

    override fun lower(value: CoreBridge): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): CoreBridge {
        return CoreBridge(value)
    }

    override fun read(buf: ByteBuffer): CoreBridge {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: CoreBridge) = 8UL

    override fun write(value: CoreBridge, buf: ByteBuffer) {
